...
import PlayerPreview from '../reusable/ProfilePreview';
  ...
  render() {
    ...
    return (
      <form className='column' onSubmit={this.handleSubmit}>
        ...
        <input id='username' placeholder='username' type='text' value={username} autoComplete='off' onChange={this.handleChange} />
